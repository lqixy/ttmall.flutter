        ...
        child: BlocBuilder<CartBloc, CartState>(
          builder: (context, state) {
            if (state is CartLoadingState) {
              ...
              var total = state.model.total! - state.model.coupon!;
              return Stack(
                children: [
                  SizedBox(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Column(
                                                                            children: [
                                                                              CartCountOperationWidget('${goods.purchasenum}'),
                                                                              Offstage(
...
//   const CartStoreWidget(this.model, {super.key});
//   final CartStoreModel model;
//   @override
...
//   void _initCheck() {
//     isCheck = !widget.model.data!.any((element) => !element.ischeck!);
//   }
...
//                       style: AppTextStyle.appTextStyle(
//                           AppConfig.primaryTextColorBlack, 12.sp,
//                           fw: FontWeight.bold),
//                     ),
//                   ))
//             ],
...
//         Column(
//           children:
//               widget.model.data!.map((e) => CartProductItemWidget(e)).toList(),
//         ),
//       ],
//     );
//   }
...
//   const CartProductItemWidget(this.goods, {super.key});
...
//                 // checkColor: AppConfig.primaryBackgroundColorGrey,
//                 shape: const CircleBorder(),
//                 value: widget.goods.ischeck,
//                 onChanged: (value) {
//                   setState(() {
//                     // isCheck = value!;
//                     widget.goods.ischeck = value!;
//                   });
//                 },
//               )),
//           Expanded(
...
//                           child: CustomCachedNetworkImageWidget(
//                               imageUrl: widget.goods.goodsurl!),
//                         )),
//                     Expanded(
//                         flex: 2,
//                         child: Column(
...
//                                     child: Column(
//                                       children: [
//                                         CartCountOperationWidget(
//                                             '${widget.goods.purchasenum}'),
//                                         Offstage(
//                                             offstage: widget.goods.stock != 1,
//                                             child: Text(
//                                               '当前库存为1件',
//                                               style: AppTextStyle.appTextStyle(
//                                                   AppConfig
...
class CartCountOperationWidget extends StatefulWidget {
  const CartCountOperationWidget(this.text, {super.key});
  final String text;
  @override
